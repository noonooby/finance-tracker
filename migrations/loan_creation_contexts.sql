-- ============================================================================
-- LOAN CREATION CONTEXTS - DATABASE MIGRATION
-- Version: 1.0 | Date: 2025-10-17
-- ============================================================================
-- PURPOSE: Store loan creation templates for quick re-use
-- TRIGGER: loan_name (e.g., "Car Loan", "Student Loan")
-- CONTEXT: principal, interest_rate, payment_amount, frequency
-- ============================================================================
